...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    if($rows_fetched==0)
    {
        ...
        <script>
            ...
            window.location = "http://localhost/shillu_shetty/user_login.php"
        </script>
        <?php
    }
    else
    {
        ...
        ?>
        <script>
        window.location = "http://localhost/shillu_shetty/user_after_login.php" ;
        </script>
        <?php
    }
...
<nav class="navbar navbar-inverse">
    ...
    <div class="login-dark">
        ...
        <form method="post" action="#">
            ...
            <a class="forgot" href="user_create.php">Create Account?</a>
        </form>
    </div>
